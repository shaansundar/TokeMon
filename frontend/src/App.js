...
const App = () => {
  ...
  useEffect(() => {
    const fetchNFTMetadata = async () => {
      ...
      if (txn.name) {
        console.log("🚀 ~ file: App.js ~ line 131 ~ fetchNFTMetadata ~ txn.name", txn.name)
  ...
  return (
    ...
    <div className="container">
      <div className="header-container">
        <p className="header gradient-text">TokeMon</p>
        <p className="sub-text">Defend the Metaverse!</p>
